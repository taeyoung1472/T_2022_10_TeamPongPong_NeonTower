////////////////////////////////////////////////////////////////////////////////////////////
                         Stylized Shoot & Hit Vol.2 (by. Kyeoms)
////////////////////////////////////////////////////////////////////////////////////////////

Thank you for purchasing the Stylized Shoot & Hit Vol.2 Package.
This note describes how this package is configured, how texture should be used, and how it works within a Particle System.

All the effect prepab is made of only three materials(Particle Additive, Particle Alpha Blended and Particle Mesh). 
Particle Additive and Alpha Blended materials use only one texture.
...
Material and shader named "VFX_lab" and "VFX_lab_(...)_object" are not used for effects. It was used in the background of Scene just to show the effect.
